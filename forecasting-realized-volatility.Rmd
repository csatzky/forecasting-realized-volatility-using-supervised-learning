...
1. During ‘normal’ times, the support vector machine algorithm with linear kernel outperforms all other considered methods. This is confirmed by two out-of-sample datasets: The `test` set and the `validation` set’s _pre-crisis_ period
...
```{r add-external-data, include=FALSE}
# load libraries
